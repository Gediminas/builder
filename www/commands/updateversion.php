...
//*1 UpdateVersion(bin_path, version, base_date)
//* -------------
//*2 bin_path  - binaries *.exe and *.dll folder
//*2 version   - version in form "major.minor.build.revision", '%B%' will be replaced by calculated build number  , e.g. "1.2.3.4", "1.2.%B%.4 some comment", "1.2.3.4 build %B%"
...
$version = str_replace('%B%', $build, $version);
